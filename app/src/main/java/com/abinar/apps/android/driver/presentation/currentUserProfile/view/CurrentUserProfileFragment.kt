package com.abinar.apps.android.driver.presentation.currentUserProfile.view
...
import com.abinar.apps.android.driver.databinding.FragmentCurrentUserProfileBinding
...
import com.abinar.apps.android.driver.presentation.currentUserProfile.viewmodel.CurrentUserProfileViewModel
...
class CurrentUserProfileFragment : Fragment(),
    com.abinar.apps.android.driver.presentation.currentUserProfile.CurrentUserProfileContract.CurrentUserProfileFragment {
    ...
    override fun updateProfile() {
        val validEditTextUserDetails: com.abinar.apps.android.driver.presentation.currentUserProfile.view.ValidEditTextUserDetails = validEditTextUserDetails()
    ...
    override fun validEditTextUserDetails(): com.abinar.apps.android.driver.presentation.currentUserProfile.view.ValidEditTextUserDetails {
        val valid = com.abinar.apps.android.driver.presentation.currentUserProfile.view.ValidEditTextUserDetails()
